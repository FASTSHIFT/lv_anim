...
static void anim_mark_list_change(void)
{
    ...
    {
        _lv_anim_task = false;//lv_task_set_prio(_lv_anim_task, LV_TASK_PRIO_OFF);
    }
    else
    {
        _lv_anim_task = true;//lv_task_set_prio(_lv_anim_task, LV_ANIM_TASK_PRIO);
    }
